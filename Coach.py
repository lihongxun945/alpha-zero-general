...
class Coach():
        ...
        while True:
            ...
            if r != 0:
                ...
                if whiteWin == -1:
                    ...
                    self.selfPlayWhiteWin += 1
                else:
                    self.selfPlayDraws += 1
                # print('trainExample: ', trainExamples)
                # print('transformed trainExample: ', [(x[0], x[2], r) for x in trainExamples])
                # return [(x[0], x[2], r * ((-1) ** (x[1] != self.curPlayer))) for x in trainExamples]
                return [(x[0], x[2], (r if x[1] == self.curPlayer else -r) * (self.args.reduce**(episodeStep - x[3]))) for x in trainExamples]
    ...
    def learn(self):
        ...
        for i in range(1, self.args.numIters + 1):
            ...
            print('self play summary: black ', self.selfPlayBlackWin,' ,white ', self.selfPlayWhiteWin, ', draws ', self.selfPlayDraws)
