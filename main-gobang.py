...
args = dotdict({
    ...
    # 'tempThreshold': 15,        # 蒙特卡洛搜索温度阈值，每一次self play的前tempThreshold 步，会采用更随机的策略，否则采用更优策略
    'tempThreshold': 4,        # 蒙特卡洛搜索温度阈值，每一次self play的前tempThreshold 步，会采用更随机的策略，否则采用更优策略
